...
# Source file
TRAIN_SRC = 'data/src_data/src-train.txt'
TRAIN_TGT = 'data/src_data/tgt-train.txt'
DEV_SRC = 'data/src_data/src-dev.txt'
DEV_TGT = 'data/src_data/tgt-dev.txt'
TEST_SRC = 'data/src_data/src-test.txt'
TEST_TGT = 'data/src_data/tgt-test.txt'
...
dic_size = 34000
vocab_dir = 'data/processed/vocab.dic'
